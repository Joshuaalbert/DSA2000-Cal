...
docker compose -f "$SCRIPT_DIR"/docker-compose.yaml build --no-cache simulate_ionosphere
docker compose -f "$SCRIPT_DIR"/docker-compose.yaml up -d --force-recreate simulate_ionosphere
