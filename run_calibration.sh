...
docker compose -f "$SCRIPT_DIR"/docker-compose.yaml build --no-cache calibration
docker compose -f "$SCRIPT_DIR"/docker-compose.yaml up -d --force-recreate calibration
