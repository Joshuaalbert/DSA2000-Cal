...
docker compose -f "$SCRIPT_DIR"/docker-compose.yaml build --no-cache dft_predict
docker compose -f "$SCRIPT_DIR"/docker-compose.yaml up -d --force-recreate dft_predict
