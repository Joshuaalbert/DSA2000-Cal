...
def main(array_name: str, with_autocorr: bool, field_of_view: au.Quantity | None,
    ...
    # Connect to Ray.
    ray.init(address=os.environ.get("RAY_HEAD_ADDRESS", "auto"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('field_of_view', default=None, type=float, help='Field of view in degrees.')
    parser.add_argument('oversample_factor', default=5., type=float, help='Oversample factor for the image.')
    parser.add_argument('full_stokes', default=True, type=bool, help='Use full stokes.')
    ...
    main(array_name=args.array_name, with_autocorr=False, field_of_view=args.field_of_view,
