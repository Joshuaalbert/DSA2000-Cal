...
from dsa2000_fm.systematics.ionosphere import construct_eval_interp_struct, IonosphereLayerIntegral


def test_ionosphere_frozen_flow():
    ...
    K, mean = ionosphere.compute_process_params(antennas_gcrs, times_jax, directions_gcrs)
    D, T, A = np.shape(mean)
