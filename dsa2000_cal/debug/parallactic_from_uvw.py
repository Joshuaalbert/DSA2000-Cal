...
def parallactic_angle(u, v, w, dec, lat):
    ...
    Args:
        u: U component of the source position vector (in the tangent plane)
        v: V component of the source position vector (in the tangent plane)
        w: W component of the source position vector (in the tangent plane)
