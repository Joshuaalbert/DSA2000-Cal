...
class SimulateSystematics:
    ...
    def simulate(self, ms: MeasurementSet) -> ProductGainModel:
        ...
        if len(ms.meta.x) > 1:
            ...
            observation_duration = (ms.meta.x[-1] - ms.meta.x[0]).sec * au.s
        ...
        ionosphere_gain_model = ionosphere_gain_model_factory(
            pointing=ms.meta.pointings[0],
            field_of_view=field_of_view,
            model_freqs=ms.meta.freqs,
            spatial_resolution=2. * au.km,
            observation_start_time=ms.meta.x[0],
        ...
        dish_effect_gain_model = dish_effects_gain_model_factory(
            pointing=ms.meta.pointings[0],
