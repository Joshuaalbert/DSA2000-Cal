...
from dsa2000_cal.common.bbs_utils import create_sky_model
from dsa2000_cal.adapter.create_casa_ms import create_makems_config
from dsa2000_cal.common.fits_utils import transform_to_wsclean_model
...
def main(prepare_run_config: PrepareRunConfig):
    ...
    makems_config_file = create_makems_config(
        ...
        phase_tracking=pointing_centre,
